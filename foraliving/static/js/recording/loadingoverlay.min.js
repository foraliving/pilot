...
!function (a, b) {
    function d(c, d) {
        ...
        if (g === b && (g = 0), 0 == g) {
            ...
            if (d.zIndex !== b && h.css("z-index", d.zIndex), d.image && h.css({
                    "background-image": "url(" + d.image + ")",
                    "background-position": d.imagePosition,
                    "background-repeat": "no-repeat"
                }), d.fontawesome && a("<div>", {"class": "loadingoverlay_fontawesome " + d.fontawesome}).appendTo(h), d.custom && a(d.custom).appendTo(h), e ? h.css({
                    position: "fixed",
                    top: "10%",
                    left: 0,
                    width: "100%",
                    height: "100%"
                }) : h.css("position", "fixed" == c.css("position") ? "fixed" : "absolute"), f(c, h, d, e), d.resizeInterval > 0) {
                var i = setInterval(function () {
                    f(c, h, d, e)
                }, d.resizeInterval);
                c.data("LoadingOverlayResizeIntervalId", i)
            }
            d.fade ? d.fade === !0 ? d.fade = [400, 200] : ("string" == typeof d.fade || "number" == typeof d.fade) && (d.fade = [d.fade, d.fade]) : d.fade = [0, 0], c.data({
                LoadingOverlay: h,
                LoadingOverlayFadeOutDuration: d.fade[1]
            }), h.hide().appendTo("body").fadeIn(d.fade[0])
        }
    ...
    function f(b, c, d, e) {
        if (!e) {
            ...
            c.css({
                top: f.top + parseInt(b.css("border-top-width"), 10),
                left: f.left + parseInt(b.css("border-left-width"), 10),
                width: b.innerWidth(),
